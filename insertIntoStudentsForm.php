...
<body>
	...
	<?php
		...
		if($result = $mysqli->query("INSERT INTO Director_Other(Passport,TaxCode,department_id_worker) VALUES('$Passport','$TaxCode','$department_id_worker')")) {   // $mysqli - наш об'єкт, через який здійснюємо підключення, query - метод, який дозволяє виконати довільний запит
